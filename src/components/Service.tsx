...
const Service = () => {
  ...
  return (
    <section className="bg-black p-10">
      <div className=" bg-gray-600 h-full border-white border-2 rounded-xl w-full overflow-hidden flex flex-col lg:w-1/2 lg:mx-auto">
        ...
        <div className="flex justify-center w-full h-full p-5 gap-5 flex-wrap">
          {/* animate div */}
          <motion.div
            className="bg-[#7367F0] w-60 h-80 relative rounded-3xl flex flex-col flex-wrap justify-center items-center"
          ...
          >
            <motion.div
              ...
              initial={{ opacity: 1 }}
              animate={{ opacity: isHovered ? 0.3 : 1, y: isHovered ? 100 : 0 }}
            ...
            <motion.h3
              ...
              transition={{ duration: 0.5 }}
            >
              {!isHovered ? <>tech <br />solutions</> : <>tech solutions</>}
            </motion.h3>
            {isHovered && (
              <motion.ul
                initial={{ opacity: 0 }}
          ...
          <motion.div
            className="bg-[#7367F0] w-60 h-80 relative rounded-3xl flex flex-col justify-center items-center"
          ...
          >
            <motion.div
              className="size-36 bg-blue-600 shadow-xl -mt-9 mb-6 flex justify-center items-center" 
              initial={{ opacity: 1 }}
              animate={{ opacity: isHovered2 ? 0.3 : 1, y: isHovered2 ? 100 : 0 }}
              transition={{ duration: 0.5 }}
            >
              {/* image */}
              image
            ...
            <motion.h3
              ...
              transition={{ duration: 0.5 }}
            >
              {!isHovered2 ? <>tax <br />solutions</> : <>tax solutions</>}
            </motion.h3>
            {isHovered2 && (
              <motion.ul
                initial={{ opacity: 0 }}
